...
${style}`.trim();
        // 将示例代码中的相对路径转为npm包路径
        exampleCode = exampleCode.replace('../easyest-dropdown', 'easyest-dropdown');
        exampleCode = exampleCode.replace('../BsDropdownTransition.vue', 'easyest-dropdown/vue3/es');
        exampleCode = exampleCode.replace('../easy-dropdown-transition.scss', 'easyest-dropdown/vue3/es/easyest-dropdown.css');
